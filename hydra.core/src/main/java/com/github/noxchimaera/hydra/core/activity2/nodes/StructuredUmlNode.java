 ...
 * @author Nox
 */
public abstract class StructuredUmlNode extends UmlNode implements IHasInput, IHasOutput {
    ...
    public
    StructuredUmlNode(long id, NodeType type, String value) {
        super(id, type, value);
    ...
    public
    Optional<StructuredUmlNodeRegion> getRegion(String regionName) {
    ...
    public
    List<StructuredUmlNodeRegion> getRegions() {
